...
<head>
    ...
    <title>Chat Demo - {{ config('app.name') }}</title>
                        ...
                        <div class="prose max-w-none text-gray-600 space-y-4">
                            ...
                            <div class="grid md:grid-cols-2 gap-6 my-8">
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                                    ...
                                    <p class="text-sm text-blue-800">
                                        Messages are delivered instantly using WebSocket technology powered by Laravel Reverb.
                                    </p>
                                </div>
                                ...
                                <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                                    ...
                                    <p class="text-sm text-green-800">
                                        See when your messages have been read by support agents with blue checkmarks.
                                    </p>
                                </div>
                            ...
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 mt-8">
                                ...
                                <ol class="list-decimal list-inside space-y-2 text-gray-700">
                                    ...
                                    <li>Wait for a support agent to respond (in this demo, you can open the admin panel to respond yourself)</li>
                                </ol>
                            </div>
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-yellow-800 mt-1">
                                            To test the admin side, log in to the <a href="/admin" class="underline font-medium">Filament Admin Panel</a>
